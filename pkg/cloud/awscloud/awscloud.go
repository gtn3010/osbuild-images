...
func (a *AWS) Register(name, bucket, key string, shareWith []string, rpmArch string, bootMode *string, importRole string, encrypted bool, kmsKey string) (*string, *string, error) {
